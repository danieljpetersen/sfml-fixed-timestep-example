    ...
    # -----
    #
    # When you try to locate the SFML libraries, you must specify which framework you want to use (system, window, graphics, network, audio, main).
    # If none is given, the SFML_LIBRARIES variable will be empty and you'll end up linking to nothing.
    # example:
    #   find_package(SFML COMPONENTS graphics window system) # find the graphics, window and system framework
    #
    ...
    # you must init the SFML_STATIC_LIBRARIES variable to TRUE before calling find_package(SFML ...).
    # Since you have to link yourself all the SFML dependencies when you link it statically, the following
    # additional variables are defined: SFML_XXX_DEPENDENCIES and SFML_DEPENDENCIES (see their detailed
    # description below).
    # In case of static linking, the SFML_STATIC macro will also be defined by this script.
    # example:
    #   init(SFML_STATIC_LIBRARIES TRUE)
    #   find_package(SFML 2 COMPONENTS network system)
    #
    # On Mac OS X if SFML_STATIC_LIBRARIES is not init to TRUE then by default CMake will search for frameworks unless
    # CMAKE_FIND_FRAMEWORK is init to "NEVER" for example. Please refer to CMake documentation for more details.
    ...
    #   - SFML_XXX_LIBRARY_DEBUG:   the name of the debug library of the xxx module (init to SFML_XXX_LIBRARY_RELEASE is no debug version is found)
    #   - SFML_XXX_LIBRARY_RELEASE: the name of the release library of the xxx module (init to SFML_XXX_LIBRARY_DEBUG is no release version is found)
    #   - SFML_XXX_LIBRARY:         the name of the library to link to for the xxx module (includes both debug and optimized names if necessary)
    #   - SFML_XXX_FOUND:           true if either the debug or release library of the xxx module is found
    #   - SFML_XXX_DEPENDENCIES:    the list of libraries the module depends on, in case of static linking
    # - SFML_LIBRARIES:    the list of all libraries corresponding to the required framework
    # - SFML_FOUND:        true if all the required framework are found
    ...
    # defineJSONVariable the SFML_STATIC macro if static build was chosen
    if(SFML_STATIC_LIBRARIES)
    add_definitions(-DSFML_STATIC)
    endif()

    # defineJSONVariable the list of search paths for headers and libraries
    set(FIND_SFML_PATHS
    ${SFML_ROOT}
    $ENV{SFML_ROOT}
    ~/Library/Frameworks
    /Library/Frameworks
    C:/Users/dan/Desktop/SFML/build/lib
    C:/Users/dan/Desktop/SFML
    C:/Users/danie/Desktop/SFML/build/lib
    C:/Users/danie/Desktop/SFML
    /usr
    /sw
    /opt/local
    /opt/csw
    ...
    set(SFML_FOUND TRUE) # will be init to false if one of the required framework is not found
    ...
    # if both are found, init SFML_XXX_LIBRARY to contain both
    if (SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_DEBUG AND SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_RELEASE)
    set(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY debug     ${SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_DEBUG}
    optimized ${SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_RELEASE})
    endif()

    # if only one debug/release variant is found, init the other to be equal to the found one
    ...
    # in case of static linking, we must also defineJSONVariable the list of all the dependencies of SFML libraries
    if(SFML_STATIC_LIBRARIES)
    ...
    # onUpdate the list -- these are only system libraries, no need to find them
